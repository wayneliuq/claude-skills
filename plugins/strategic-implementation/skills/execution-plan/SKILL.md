...
3. Load `docs/strategic-implementation/project-learnings.md` if it exists. Filter entries for relevance to this brief's deliverables. Inject matching entries when invoking `review`.
...
### D1 — <name>
- **Validation:** <preview | cli | tdd | post-hoc> — <exact command / exact behavior to observe / exact test to write>
