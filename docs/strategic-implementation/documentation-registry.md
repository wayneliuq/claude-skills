...
| `plugins/strategic-implementation/skills/executing-plans/SKILL.md` | deliverable-gated execution (DAG order, per-deliverable validate + atomic commit) | 2026-05-31 | execution-model change, commit-model change, parallelism change | strategic-implementation |
